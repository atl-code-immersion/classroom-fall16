...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { grade: @teacher.grade, name: @teacher.name, room: @teacher.room } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { grade: @teacher.grade, name: @teacher.name, room: @teacher.room } }
